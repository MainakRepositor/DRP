...
def app(df):
    ...
    with st.expander("View Data Source"):
        ...
        st.markdown('''https://www.kaggle.com/datasets/brijlaldhankour/parametric-skin-disease-prediction/data''')
        st.markdown('''https://www.kaggle.com/datasets/shubhamgoel27/dermnet/code''')
